...
from refact import frame_class #TODO Change
from refact import motion_estimation #TODO Change
    ...
    while cap.isOpened():
        ...
        if succ: # Frame was correctly acquired
            ...
            if previous_frame is not None:
                ...
                motion_estimation.motion_estimation(previous_frame, new_frame, matched_features)
